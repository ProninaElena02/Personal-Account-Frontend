...
// const CommentForm: React.FC<CommentFormProps> = ({ articleDocumentId, onClose }) => {
//   const dispatch = useDispatch<AppDispatch>();
//   const user = useSelector(selectUser);
//   const [text, setText] = useState('');
//   const [errors, setErrors] = useState<FormErrors>({});
...
//     const validationError = validateForm({ text }, 'note');
//     if (validationError) {
...
//       setIsSubmitting(false);
//     }
//   }, [dispatch, user?.documentId, text, articleDocumentId, onClose]);
